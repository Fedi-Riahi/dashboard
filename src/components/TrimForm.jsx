      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <>
            ...
            <div className="flex items-center  ps-4 border border-gray-200 rounded dark:border-gray-700">
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, onDemand: e.target.checked })
                }
            ...
            <div className="col-span-3">
              <h3 className="text-lg font-bold mb-2">
                Consommation and emission
              </h3>
            </div>
            <div className="mb-4">
              <label
                className="block text-sm font-medium mb-2"
                htmlFor="consommationWLTP"
              >
                Consommation WLTP{" "}
                <span className="text-zinc/70">( l/100km )</span>
              </label>
              <input
                type="text"
                id="consommationWLTP"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, consommationWLTP: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="emissions"
              >
                Emissions <span className="text-zinc/70">( g/km )</span>
              </label>
              <input
                type="text"
                id="emissions"
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="capacity"
              >
                Capacity <span className="text-zinc/70">( L )</span>
              </label>
              <input
                type="text"
                id="capacity"
          ...
          <>
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="cylinders"
              >
                Cylinders <span className="text-zinc/70">( cc )</span>
              </label>
              <input
                type="text"
                id="cylinders"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, cylinders: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="couple"
              >
                Couple <span className="text-zinc/70">( Nm )</span>
              </label>
              <input
                type="text"
                id="couple"
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="puissance"
              >
                Puissance <span className="text-zinc/70">( kW (ch) )</span>
              </label>
              <input
                type="text"
                id="puissance"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="15.5"
                onChange={(e) =>
                  setFormData({ ...formData, compression: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="maxSpeed"
              >
                Max Speed <span className="text-zinc/70">( km/h )</span>
              </label>
              <input
                type="text"
                id="maxSpeed"
            ...
            <div className="mb-4">
              ...
              >
                Acceleration <span className="text-zinc/70">( s/100km )</span>
              </label>
              <input
                type="text"
                id="acceleration"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, transmissionType: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
          ...
          <>
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="length"
              >
                Length <span className="text-zinc/70">( mm )</span>
              </label>
              <input
                type="text"
                id="length"
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="height"
              >
                Height <span className="text-zinc/70">( mm )</span>
              </label>
              <input
                type="text"
                id="height"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2" htmlFor="width">
                Width <span className="text-zinc/70">( mm )</span>
              </label>
              <input
                type="text"
                id="width"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2" htmlFor="doors">
                Doors
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, frontWheels: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, rearWheels: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
        ...
        {step === 4 && (
          <>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2" htmlFor="PTAC">
                P.T.A.C <span className="text-zinc/70">( kg )</span>
              </label>
              <input
                type="text"
                id="PTAC"
                ...
                value={formData.PTAC}
                onChange={(e) =>
                  setFormData({ ...formData, PTAC: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="emptyWeight"
              >
                Empty Weight <span className="text-zinc/70">( kg )</span>
              </label>
              <input
                type="text"
                id="emptyWeight"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, emptyWeight: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                ...
                htmlFor="maxCharge"
              >
                Max Charge <span className="text-zinc/70">( kg )</span>
              </label>
              <input
                type="text"
                id="maxCharge"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, maxCharge: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              ...
              >
                Trailer Weight <span className="text-zinc/70">( kg )</span>
              </label>
              <input
                type="text"
                id="trailerWeight"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, trailerWeight: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
            ...
            <div className="mb-4">
              <label
                className="block text-sm font-medium mb-2"
                htmlFor="trunkCapacity"
              >
                Trunk Capacity <span className="text-zinc/70">( L )</span>
              </label>
              <input
                type="text"
                id="trunkCapacity"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, trunkCapacity: e.target.value })
                }
                className="mt-1 p-3 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500"
                required
              />
